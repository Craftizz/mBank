...
public class BankStatisticsGUI {
    ...
    private final UserBankData bankData;
    ...
    public BankStatisticsGUI(final @NotNull UserBankData bankData,
        ...
        this.bank = bank;
        this.guiYaml = guiYaml;

        final Component title = MessageUtil.parse(guiYaml.getString("statistics.title"), "bank", bank.getDisplayName());
    ...
    private void setup() {
        ...
        if (balanceMaterial != null) {
            final GuiItem balanceItem = ItemBuilder.from(balanceMaterial)
                    ...
                    .lore(MessageUtil.parseMany(balanceSection.getStringList("lore"),
                            ...
                            "interest", NumberUtils.formatCurrency(bankData.getTotalInterestEarning()),
                            "crisis", NumberUtils.formatCurrency(bankData.getTotalLostInCrisis())))
                    .asGuiItem();
        ...
        if (crisisMaterial != null) {
            final GuiItem balanceItem = ItemBuilder.from(crisisMaterial)
                    ...
                    .asGuiItem();
            gui.updateItem(crisisSection.getInt("slot"), balanceItem);
        }
    }
        ...
        if (balanceMaterial != null) {
            final GuiItem balanceItem = ItemBuilder.from(balanceMaterial)
                    ...
                    .lore(MessageUtil.parseMany(balanceSection.getStringList("lore"),
                            ...
                            "crisis", NumberUtils.formatCurrency(bankData.getTotalLostInCrisis())))
                    .asGuiItem();
            gui.updateItem(balanceSection.getInt("slot"), balanceItem);
        }
        ...
        if (interestMaterial != null) {
            final GuiItem balanceItem = ItemBuilder.from(interestMaterial)
                    ...
                    .lore(MessageUtil.parseMany(interestSection.getStringList("lore") ,
                            ...
                            "earning4", NumberUtils.formatCurrency(earning4)))
                    .asGuiItem();
            gui.updateItem(interestSection.getInt("slot"), balanceItem);
        }
